    ...
    <SafeAreaView className="flex-1 bg-[#F5EDE2]">
      ...
      <View className="flex-1">
        ...
        <View className="flex-[0.65] relative items-center justify-center">
          ...
          {/* Main Character Image - Large and shifted way down and left */}
          <View className="absolute inset-0 justify-end items-start mb-[-150px] ml-[px]">
            <Image
              source={require('../../assets/images/goods 1.png')}
        ...
        <View className="flex-[0.35] bg-white rounded-t-3xl px-6 pt-6 pb-6 justify-between">
          ...
          <View className="items-center flex-1 justify-center">
            ...
            <Text className="text-sm text-gray-500 text-center leading-5 px-2">
              Put your knowledge to the test and prove your expertise across a wide range of topics in this engaging quiz game.
            </Text>
          </View>
